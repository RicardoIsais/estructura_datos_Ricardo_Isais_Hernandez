...
public class caja4 extends Thread {
    ...
    public caja4(Cliente cliente, BilletesCaja4 billete) {
	...
	private void mostrarCantidadEnCaja() {
		System.out.println("Cantidad de monedas en la caja 4:");
